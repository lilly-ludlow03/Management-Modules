...
// Double-check if user logged in
if (!isLoggedIn()) {
...
<meta http-equiv="Expires" content="0">
    ...
    <style>
        ...
        .main {
            ...
            padding-right: 10px;
            height: calc(100vh - 60px); /* Adjust height accounting for top bar when needed */
        }
        .plot {
            flex: 0 0 70%;
        ...
        .expanded-view {
            ...
            overflow-y: auto; /* Allow full page scrolling for the large tables */
        }
        .expanded-view > div {
            max-height: none !important; 
            flex: 1; /* Ensure content takes the available space */
        }
        ...
        .result-section {
            ...
            padding: 15px;
            border-radius: 5px;
            position: relative; /* For expand the button */
            background: white;
        }
        ...
        .data-table.mb-20 { margin-bottom: 20px; }
        .table-header-row { background-color: #f2f2f2; }
        .table-th, .table-td {
            border: 1px solid #ddd;
            padding: 8px;
        }
        ...
        /* Dynamic Filters */
        .divider { border: 1px solid #ccc; margin-top: 20px; }
        .divider-small { border: 1px solid #ccc; margin-top: 5px; margin-bottom: 20px; }
...
<body>
<!-- JavaScript session check for backup -->
<script src="../session-check.js">
</script>
    <div class="content">
        <div class="top">
            <h1>General Transaction Information</h1>
            ...
            <div id="results-container" class="hidden">
                ...
                <div class="graphs-grid">
                    <div class="result-section graph-section">
                        ...
                        <canvas id="disruptionLineChart"></canvas>
                    </div>
                    <div class="result-section graph-section">
                        <button class="expand-btn" title="Enlarge Graph" onclick="toggleExpand(this)">&#x2922;</button>
                ...
                <div class="result-section">
                    ...
                    <div class="table-scroll-container">
                        <table id="company-stats-table" class="data-table mb-20">
                            <thead>
                                <tr class="table-header-row">
                                    <th class="table-th">Company Name</th>
                                    <th class="table-th">On Time Delivery Rate</th>
                                    <th class="table-th">Products</th>
                                    <th class="table-th">Disruption Type</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
                ...
                <div class="result-section">
                    ...
                    <div class="table-scroll-container-large">
    ...
    <!-- Page functionality -->
    <script src="general-transactions.js"></script>
</body>
</html>