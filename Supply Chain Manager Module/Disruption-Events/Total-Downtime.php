...
<meta http-equiv="Expires" content="0">
    ...
    <style>
        ...
        /* Adjusting the label styling for the sidebar */
        ...
        .main {
            transition: all 0.3s ease; /* Used for Smooth transition in website */
        }
...
<script src="../session-check.js"></script>
    ...
    <div class="content">
        <!-- Top bar with title, user name, logout -->
        <div class="top">
            <h1>Total Downtime</h1>
        ...
        <div class="main">
            <h2 class="subheading-text">Total Downtime Per Company</h2>
        ...
        <!-- Modified Plot Section for intended Results -->
        <div class="plot">
            ...
            <div id="results-area" class="hidden">
                <div class="subheading">
                    <p class="subheading-text">Total Downtime</p>
                </div>
    ...
    <script src="total-downtime.js"></script>
</body>
</html>