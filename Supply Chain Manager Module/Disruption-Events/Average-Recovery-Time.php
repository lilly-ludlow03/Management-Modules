<?php
/**
 * Average-Recovery-Time.php - Protected Page
 * 
...
<script src="../session-check.js"></script>
    ...
    <div class="content">
        ...
        <div class="main">
            <h2>Average Recovery Time Per Company</h2>
        ...
        <div class="plot">
            ...
            <div id="results-area" class="hidden">
                <div class="subheading">
                    <p class="subheading-text">Average Recovery Time Distribution</p>
                </div>
    ...
    <script src="average-recovery-time.js"></script>
