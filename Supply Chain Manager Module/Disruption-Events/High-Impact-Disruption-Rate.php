<?php
// Send no-cache headers IMMEDIATELY before any of the output
...
<html>
<head>
<!-- NO CACHE meta tags as a backup -->
...
<meta http-equiv="Expires" content="0">
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            overflow: hidden; /* Prevents the whole page scrolling */
            height: 100vh;
        }
        .content {
            height: 100vh; /* Ensure content that takes full viewport on the height */
            display: flex;
            flex-wrap: wrap;
        }
        .main {
            flex: 0 0 30%;
            overflow-y: auto; /* Filters can scroll independently */
            padding-right: 10px;
        ...
        .graph-container {
            flex: 0 0 60%;
            padding-left: 10px;
            height: 600px; /* Match increased height */
            display: flex; 
            align-items: center; 
        ...
        /* Adjust label styling for sidebar */
        ...
        .graph-container .expand-btn {
            left: 25px; /* Extra shift for the graph container padding */
        }
        .expand-btn:hover {
            background-color: #f0f0f0;
        }
        
        /* Expanded State for the Styles */
        .expanded-view {
...
<body>
<!-- JavaScript session check for backup protecction -->
<script src="../session-check.js"></script>
    ...
    <div class="content">
        <div class="top">
            <h1>High Impact Disruption Rate</h1>
        ...
        <!-- Changed Main Section with the Filters -->
        <div class="main">
            <div class="heading">
                <h2>High Impact Disruption Rate Per Company</h2>
            </div>
        ...
        <div class="plot">
            ...
            <div id="placeholder-message" class="placeholder-message">
                <p>Click "Go" button to display results!</p>
    ...
    <script src="high-impact-disruption.js"></script>
</body>
</html>