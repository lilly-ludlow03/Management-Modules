...
<meta http-equiv="Expires" content="0">
    ...
    <style>
        ...
        .content {
            height: 100vh; /* Ensure that content on the takes full viewport height */
            display: flex;
            flex-wrap: wrap;
        }
        .main {
            flex: 0 0 30%;
            overflow-y: auto; /* Allows the internal scrolling for the sidebar */
            padding-right: 10px;
            height: calc(100vh - 60px); /* Adjust for the height accounting for top bar */
            transition: all 0.3s ease; 
        }
        .plot {
            flex: 0 0 70%;
            overflow-y: auto; /* Allow the scrolling for the plot area */
        ...
        /* When filters are hidden stretch plot area to full width */
        ...
        /* "Expand" icon overlay on table and chart for fullscreen view */
...
<script src="../session-check.js">
    ...
    <div class="content">
        <div class="top">
            <h1>Disruption Severity Distribution</h1>
        ...
        <!-- Changed Main Section Filters -->
        <div class="main">
                <h2 class="subheading-text">Disruption Severity Distribution Per Company</h2>
        ...
        <div class="plot">
            ...
            <div id="results-area" class="hidden">
                <div class="subheading">
                    <p class="subheading-text">Disruption Severity Distribution</p>
                </div>
    ...
    <script src="disruption-severity-distribution.js"></script>
</body>
</html>