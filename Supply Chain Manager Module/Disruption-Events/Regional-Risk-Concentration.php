<?php
/**
 * Regional-Risk-Concentration.php - Protected Page
 * 
...
<meta http-equiv="Expires" content="0">
    ...
    <style>
        ...
        .plot {
            flex: 0 0 70%;
            overflow-y: auto; /* Allow scrolling for plot area */
            height: calc(100vh - 60px);
            transition: flex-basis 0.3s ease; /* Smooth transition */
            position: relative;
        }
        /* Collapsed State */
        ...
        .expand-btn {
            position: absolute;
            top: 5px;
            left: 15px; /* Shifted right slightly to align better */
...
<script src="../session-check.js"></script>
    ...
    <div class="content">
        <div class="top">
            <h1>Regional Risk Concentration</h1>
        ...
        <!-- Modified Main Section with Filters -->
        <div class="main">
            <div class="heading">
                <h2 class="subheading-text">Regional Risk Concentration Per Company</h2>
            </div>
        ...
        <div class="plot">
            ...
            <div id="results-area" class="hidden">
                <div class="subheading">
                    <p class="subheading-text">Regional Risk Concentration</p>
                </div>
    ...
    <script src="regional-risk.js"></script>
</body>
</html>