document.addEventListener("DOMContentLoaded", () => {
    ...
    if(clearButton) {
        clearButton.addEventListener('click', () => {
            // Uncheck main checkboxes and trigger change to remove dynamic filters
            ...
            // Remove limit dropdown if desired, or just leave it hidden with container
            ...
            if (distributorChart) {
                ...
                distributorChart = null;
            }
            // Recreate canvas for next chart
            const graphContainer = document.getElementById('graph-container');
            if (graphContainer) graphContainer.innerHTML = '<canvas id="distributorChart"></canvas>';
        });
    }
    ...
    // Initialize Company Filter (it's checked by default)
    renderCompanyFilter();
    ...
    // Helper to create Limit Dropdown
    ...
    goButton.addEventListener('click', () => {
        ...
        // 3. Fetch Data
        fetch(`get_distributor_volume.php?${params.toString()}`)
    ...
    function renderTable(data) {
        ...
        thead.innerHTML = `
            <tr>
                <th class="result-th">Distributor Name</th>
                <th class="result-th">Shipment Volume</th>
        ...
        data.forEach((row, index) => {
            ...
            tr.innerHTML = `
                ...
                <td class="result-td">${row.shipment_volume}</td>
    ...
    function renderChart(data, limit = 10) {
        const canvas = document.getElementById('distributorChart');
        if (!canvas) return;
        ...
        distributorChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: chartData.map(d => d.shipment_volume),
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: { display: true, text: 'Top Distributors by Volume' }
                }
            }
        });
    }
