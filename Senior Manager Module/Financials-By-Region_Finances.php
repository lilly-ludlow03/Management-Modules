<?php
/**
 * Financials-By-Region_Finances.php - Protected Page
 * 
...
<link href="https://fonts.googleapis.com/css?family=Montserrat&family=Open Sans" rel="stylesheet"> <!--Fonts-->
    ...
    <style>
        ...
        .expanded-view > #region-table-container,
        ...
        /* Classes for structure and layout */
        .filter-container {
            margin-top: 20px; 
            text-align: center;
        }
        ...
        #table-container, #region-table-container {
            overflow-y: auto;
            flex: 1; 
            height: 100%;
        }
...
<div class="content">
	...
	<div class="top">
        <!--Heading-->
		<h1>Company Financials by Region</h1>
	...
	<!--Ribbon (drop-downs) section of the page-->
	<div class="sidebar">
        <!--Home icon-->
		<div class="home-icon">
    ...
    <div class="plot">
        ...
        <h3>Regional Financials Analysis</h3>
...
<script src="financials-by-region_finances.js"></script>
