<?php
/**
 * Top-Distributors_CompanyInformation.php - Protected Page
 * 
...
<style>
    ...
    .data-display-container {
        ...
        gap: 20px;
        margin-top: 20px;
        flex: 1; /* Match results-container behavior if needed, but flex implies parent display:flex */
    }
    /* Note: data-display-container uses display:none inline in HTML, handled by JS toggle */
...
<div class="content">
	<div class="top">
		<h1>Top Distributors by Shipment Volume</h1>
    ...
    <div class="main">
        ...
        <button id="go-button" class="go-button go-btn-mt">Go</button>
...
<script src="top-distributors_companyinformation.js"></script>
